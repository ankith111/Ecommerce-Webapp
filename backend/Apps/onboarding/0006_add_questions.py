...
def add_question(apps, schema_editor):
    ...
    for category in categories:
        OnboardingCategories.objects.create(name=category, image='/home/jayash/Desktop/Goglocal/Dev/goglocal-backend/media/onboarding/categories/test.png')
    ...
    for i in range(len(question_categories)):
        ...
        for i in range(len(questions[0])):
            ...
            qn = OnboardingQuestions(uuid=str(uuid4()), question=question_statement, order_no=i+1, category_question=question_cat)
            qn.save()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('onboarding', '0005_rename_onboardngquestions_onboardingquestions'),
    ]
